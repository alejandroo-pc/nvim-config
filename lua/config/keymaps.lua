...
keymap.set("n", "<leader>a", ":lua vim.lsp.buf.definition()<CR>", {desc = "view definition"})
keymap.set("n", "<leader>v", ":vsplit | lua vim.lsp.buf.definition()<CR>", {desc = "view split definition"})
